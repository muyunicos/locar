<?php
    ...
    $base_locar_path = DEV ? dirname(__DIR__,2) : dirname(__DIR__,3);
    ...
    define('PUBLIC_PATH', $base_locar_path . '/public_html/app' . (!DEV ? '/' . VERSION : ''));
    ...
    define('PUBLIC_URL', 'https://loc.ar/app' . (!DEV ? '/' . VERSION : ''));
